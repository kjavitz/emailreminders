<?php
class IWE_EmailReminder_Block_Adminhtml_Rule_Edit_Tab_General extends AW_Followupemail_Block_Adminhtml_Rule_Edit_Tab_General
{
    ...
    public function getSalesPersonList(){
        $result = array('0' => 'Any');
        $salesRepList = Mage::helper('amperm')->getSalesPersonList();
        return $result+$salesRepList;
    }
}